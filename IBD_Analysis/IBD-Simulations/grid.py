...
from position_update_raphael import position_update_raphael  # @UnusedImport
...
class Grid_Heterogeneous(Grid):
    ...
    nr_inds_right = 500  # Nr of diploit Individuals on the right
    ...
    nr_inds_pn = 5  # The Number of chromosomes per node
