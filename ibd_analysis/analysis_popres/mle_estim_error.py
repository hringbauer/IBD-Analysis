...
class MLE_estim_error(GenericLikelihoodModel):
    ...
    min_b, max_b = 0, 60.1  # Minimum/Maximum bin for calculations for mle_multi_run  [in cm]  # 30.2
    bin_width = 0.1  # Bin width for mle_multi_run [in cm]
    min_len, max_len = 20.0, 60.0  # Minimum/maximum bin length actually analyzed [in cm]   #4-15
